...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dat }\OtherTok{\textless{}{-}} \FunctionTok{read\_csv}\NormalTok{(}\StringTok{"https://raw.githubusercontent.com/adamflr/ST0060{-}2022/main/Data/Spotify\_data.csv"}\NormalTok{) }\CommentTok{\# Läs in en csv{-}fil från Github}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{unique}\NormalTok{(dat}\SpecialCharTok{$}\NormalTok{artist\_name)   }\CommentTok{\# Skriv ut unika (inga dubletter) värden i kolumnen artist\_name i dat}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{dat }\SpecialCharTok{\%\textgreater{}\%}                                                          \CommentTok{\# Ta datan, och sen}
  \FunctionTok{filter}\NormalTok{(artist\_name }\SpecialCharTok{\%in\%} \FunctionTok{c}\NormalTok{(}\StringTok{"Robyn"}\NormalTok{, }\StringTok{"Esperanza Spalding"}\NormalTok{)) }\SpecialCharTok{\%\textgreater{}\%}  \CommentTok{\# filtrera för specifika artister, och sen}
...
\begin{Highlighting}[]
\NormalTok{dat }\SpecialCharTok{\%\textgreater{}\%}                             \CommentTok{\# Ta datan, och sen}
  \FunctionTok{select}\NormalTok{(artist\_name, album\_name)   }\CommentTok{\# väljd kolumnerna artist\_name och album\_name}
\end{Highlighting}
\end{Shaded}
...
Följande stycke beräknar kvoten av kolumnerna valence och danceability i en ny kolumn \texttt{valence\_to\_danceability}.
...
Gör lämpliga ändringar för att multiplicera \texttt{tempo} och \texttt{time\ signature}. Ett passande namn för den nya kolumnen kan vara \texttt{tempo\_times\_time\_signature}.
\end{exercise}

I exemplet och uppgiften ovan skapades nya kolumn namn med understreck \texttt{\_} istället för mellanrum. Om man vill ha mellanrum i sina kolumnnamn måste man skriva namnet inom \emph{backticks} ``` för att ange att namnet ska tolkas som en enhet.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dat }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{mutate}\NormalTok{(}\StringTok{\textasciigrave{}}\AttributeTok{Valence to danceability}\StringTok{\textasciigrave{}} \OtherTok{=}\NormalTok{ valence }\SpecialCharTok{/}\NormalTok{ danceability) }\SpecialCharTok{\%\textgreater{}\%} \CommentTok{\# Namnet Valence to danceability skrivs inom backticks}
  \FunctionTok{select}\NormalTok{(artist\_name, }\StringTok{\textasciigrave{}}\AttributeTok{Valence to danceability}\StringTok{\textasciigrave{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
## # A tibble: 76,622 x 2
##    artist_name `Valence to danceability`
##    <chr>                           <dbl>
##  1 100 gecs                        1.81 
##  2 100 gecs                        0.726
##  3 100 gecs                        0.683
...
Funktionen \texttt{count()} ger antalet rader uppdelat efter valfri kolumn. Den kan användas som en kortform för \texttt{group\_by()} och \texttt{summarise()}. Vad måste ändras i stycket nedan för att se vilka artister som påverkar värdet för 1960?

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dat }\SpecialCharTok{\%\textgreater{}\%}                                              \CommentTok{\# Ta data, och sen}
  \FunctionTok{filter}\NormalTok{(album\_release\_year }\SpecialCharTok{==} \DecValTok{1976}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}             \CommentTok{\# ta ut rader där år är 1976, och sen}
  \FunctionTok{count}\NormalTok{(artist\_name, album\_name, album\_release\_year) }\CommentTok{\# räkna antalet rader per artist, album och år}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot}\NormalTok{(}\AttributeTok{x =}\NormalTok{ dat\_small}\SpecialCharTok{$}\NormalTok{tempo, }\AttributeTok{y =}\NormalTok{ dat\_small}\SpecialCharTok{$}\NormalTok{danceability)   }\CommentTok{\# Plotta en graf med tempo och dansbarhet på axlarna}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-52-1} \end{center}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{ggplot}\NormalTok{(dat\_small, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ mode\_name, }\AttributeTok{y =}\NormalTok{ valence, }\AttributeTok{color =}\NormalTok{ album\_name)) }\SpecialCharTok{+} \CommentTok{\# Ta datan och koppla variabler till egenskaper}
  \FunctionTok{geom\_point}\NormalTok{() }\SpecialCharTok{+}                                                         \CommentTok{\# Illustrera med punkter}
...
Andra graftyper kan skapas med andra \texttt{geom\_}-funktioner. För ett linjediagram används \texttt{geom\_line}. De observationer som ska ge en specifik linje anges med \texttt{group} i \texttt{aes}-funktionen. Låt oss beräkna medeldansbarhet över tid, uppdelat efter markeringen för \emph{explicit} (alltså om spåret är barnvänligt eller inte). Exemplet visar också hur man använda flera geometrier genom att lägga till dem efter varandra med \texttt{+}.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dat\_mean\_over\_time }\OtherTok{\textless{}{-}}\NormalTok{ dat }\SpecialCharTok{\%\textgreater{}\%}                         \CommentTok{\# Ta datan, och sen}
  \FunctionTok{group\_by}\NormalTok{(album\_release\_year, explicit) }\SpecialCharTok{\%\textgreater{}\%}          \CommentTok{\# gruppera efter år och explicitet, och sen}
  \FunctionTok{summarise}\NormalTok{(}\AttributeTok{Mean\_danceability =} \FunctionTok{mean}\NormalTok{(danceability))   }\CommentTok{\# summera genom att ta medelvärdet av dansbarhet}

\FunctionTok{ggplot}\NormalTok{(dat\_mean\_over\_time, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ album\_release\_year, }\AttributeTok{y =}\NormalTok{ Mean\_danceability, }\AttributeTok{color =}\NormalTok{ explicit)) }\SpecialCharTok{+} \CommentTok{\# Koppla kolumner till egenskaper}
...
Vad ska ändras i stycket ovan för att skapa en graf över medelvalens (\texttt{valence}) istället för dansbarhet? Är barnvänlig musik gladare eller ledsnare är icke-barnvänlig?
\end{exercise}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-57-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-63-1} \end{center}
...
\FunctionTok{library}\NormalTok{(tidyverse) }\CommentTok{\# Ger ett felmeddelande om paketet inte installerats tidigare.}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{mean}\NormalTok{(dat}\SpecialCharTok{$}\NormalTok{tempo, }\AttributeTok{na.rm =}\NormalTok{ T)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{dat }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{group\_by}\NormalTok{(artist\_name) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{summarise}\NormalTok{(Antal\_spår }\OtherTok{=} \FunctionTok{n}\NormalTok{(),}
            \AttributeTok{Medeltempo =} \FunctionTok{mean}\NormalTok{(tempo),}
            \AttributeTok{Maxdansbarhet =} \FunctionTok{max}\NormalTok{(danceability))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dat\_small }\OtherTok{\textless{}{-}}\NormalTok{ dat }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{filter}\NormalTok{(artist\_name }\SpecialCharTok{==} \StringTok{"The Weeknd"}\NormalTok{)}

\FunctionTok{ggplot}\NormalTok{(dat\_small, }\FunctionTok{aes}\NormalTok{(tempo, danceability, }\AttributeTok{size =}\NormalTok{ valence, }\AttributeTok{color =}\NormalTok{ mode\_name)) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-72-1} \end{center}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{gapminder }\OtherTok{\textless{}{-}} \FunctionTok{read\_excel}\NormalTok{(}\StringTok{"C:/Users/User\_name/Downloads/Gapminder.xlsx"}\NormalTok{)}
\NormalTok{gapminder}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{gdpPercap }\OtherTok{\textless{}{-}}\NormalTok{ gapminder}\SpecialCharTok{$}\NormalTok{gdpPercap}
\FunctionTok{mean}\NormalTok{(gdpPercap)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{median}\NormalTok{(gdpPercap)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dat\_gdp\_2007 }\OtherTok{\textless{}{-}}\NormalTok{ gapminder }\SpecialCharTok{\%\textgreater{}\%} 
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-84-1} \end{center}
...
\FunctionTok{var}\NormalTok{(gdpPercap)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{sd}\NormalTok{(gdpPercap)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{IQR}\NormalTok{(gdpPercap)}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-92-1} \end{center}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{ggplot}\NormalTok{(gapminder, }\FunctionTok{aes}\NormalTok{(year, lifeExp, }\AttributeTok{fill =}\NormalTok{ continent, }\AttributeTok{group =}\NormalTok{ year)) }\SpecialCharTok{+}
  \FunctionTok{geom\_boxplot}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{facet\_wrap}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\NormalTok{ continent)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-93-1} \end{center}
...
\NormalTok{dat\_sum }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{mean\_plus\_minus\_sd =} \FunctionTok{paste}\NormalTok{(Mean, }\StringTok{"±"}\NormalTok{, SD))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{dat\_sum }\OtherTok{\textless{}{-}}\NormalTok{ dat\_sum }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{mean\_plus\_minus\_sd =} \FunctionTok{paste}\NormalTok{(}\FunctionTok{round}\NormalTok{(Mean, }\DecValTok{1}\NormalTok{), }\StringTok{"±"}\NormalTok{, }\FunctionTok{round}\NormalTok{(SD, }\DecValTok{1}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\FunctionTok{getwd}\NormalTok{()}
\FunctionTok{write\_csv}\NormalTok{(dat\_sum, }\StringTok{"Exporterad data från R.csv"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{dat }\OtherTok{\textless{}{-}}\NormalTok{ dat }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{mutate}\NormalTok{(Medelvärde }\OtherTok{=} \FunctionTok{mean}\NormalTok{(x))}
\NormalTok{dat}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{dat }\OtherTok{\textless{}{-}}\NormalTok{ dat }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{Differenser =}\NormalTok{ x }\SpecialCharTok{{-}}\NormalTok{ Medelvärde)}
\NormalTok{dat}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{dat }\OtherTok{\textless{}{-}}\NormalTok{ dat }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{Kvadrater =}\NormalTok{ Differenser}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{)}
\NormalTok{dat}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{dat\_sum }\OtherTok{\textless{}{-}}\NormalTok{ dat }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{summarise}\NormalTok{(}\AttributeTok{Kvadratsumma =} \FunctionTok{sum}\NormalTok{(Kvadrater))}
\NormalTok{dat\_sum}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dat\_sum }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{mutate}\NormalTok{(}\AttributeTok{Varians =}\NormalTok{ Kvadratsumma }\SpecialCharTok{/} \DecValTok{4}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{var}\NormalTok{(dat}\SpecialCharTok{$}\NormalTok{x)  }\CommentTok{\# Dollartecken för att ta ut kolumnen x i objektet dat}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{dat\_dice }\OtherTok{\textless{}{-}}\NormalTok{ dat\_dice }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{mutate}\NormalTok{(}\StringTok{\textasciigrave{}}\AttributeTok{Kumulativ summa}\StringTok{\textasciigrave{}} \OtherTok{=} \FunctionTok{cumsum}\NormalTok{(Utfall),}
...
\NormalTok{dat\_dice }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{Utfall =} \FunctionTok{c}\NormalTok{(\_\_\_)) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{Kast =} \DecValTok{1}\SpecialCharTok{:}\FunctionTok{n}\NormalTok{(),}
         \StringTok{\textasciigrave{}}\AttributeTok{Positivt utfall}\StringTok{\textasciigrave{}} \OtherTok{=}\NormalTok{ Utfall }\SpecialCharTok{==} \DecValTok{1}\NormalTok{,}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dat\_darwin }\OtherTok{\textless{}{-}} \FunctionTok{read\_excel}\NormalTok{(}\StringTok{"Data/Uppgiftsdata.xlsx"}\NormalTok{, }\AttributeTok{sheet =} \StringTok{"Darwin"}\NormalTok{)}
\NormalTok{dat\_darwin }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{print}\NormalTok{(}\AttributeTok{n =} \DecValTok{30}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dat\_sum }\OtherTok{\textless{}{-}}\NormalTok{ dat\_darwin }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{group\_by}\NormalTok{(\_\_\_) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{summarise}\NormalTok{(Medelvärde }\OtherTok{=} \FunctionTok{mean}\NormalTok{(\_\_\_),}
            \AttributeTok{Standardavvikelse =} \FunctionTok{\_\_\_}\NormalTok{(Utfall),}
            \StringTok{\textasciigrave{}}\AttributeTok{Antal observationer}\StringTok{\textasciigrave{}} \OtherTok{=} \FunctionTok{n}\NormalTok{(),}
            \AttributeTok{Medelfel =}\NormalTok{ Standardavvikelse }\SpecialCharTok{/} \FunctionTok{sqrt}\NormalTok{(}\StringTok{\textasciigrave{}}\AttributeTok{Antal observationer}\StringTok{\textasciigrave{}}\NormalTok{))}
\NormalTok{dat\_sum}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dat\_darwin\_kors }\OtherTok{\textless{}{-}}\NormalTok{ dat\_darwin }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{filter}\NormalTok{(Metod }\SpecialCharTok{==} \StringTok{"Korsbefruktade"}\NormalTok{)}
\FunctionTok{quantile}\NormalTok{(dat\_darwin\_kors}\SpecialCharTok{$}\NormalTok{Utfall)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dat\_darwin\_själv }\OtherTok{\textless{}{-}}\NormalTok{ dat\_darwin }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{filter}\NormalTok{(Metod }\SpecialCharTok{==} \StringTok{"Självbefruktade"}\NormalTok{)}
\FunctionTok{quantile}\NormalTok{(dat\_darwin\_själv}\SpecialCharTok{$}\NormalTok{Utfall)}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-121-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-122-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-124-1} \end{center}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{slumputfall }\OtherTok{\textless{}{-}} \FunctionTok{sample}\NormalTok{(}\AttributeTok{x =}\NormalTok{ dat\_dice6}\SpecialCharTok{$}\NormalTok{x, }\AttributeTok{size =} \DecValTok{10000}\NormalTok{, }\AttributeTok{replace =}\NormalTok{ T)}

\FunctionTok{mean}\NormalTok{(slumputfall)}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-133-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-134-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-138-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-144-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-147-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-154-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-155-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-157-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-158-1} \end{center}
...
\begin{Highlighting}[]
\NormalTok{dat\_random }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{x =} \FunctionTok{runif}\NormalTok{(}\DecValTok{100}\NormalTok{, }\AttributeTok{min =} \SpecialCharTok{{-}}\DecValTok{1}\NormalTok{, }\AttributeTok{max =} \DecValTok{1}\NormalTok{),}
                         \AttributeTok{y =} \FunctionTok{runif}\NormalTok{(}\DecValTok{100}\NormalTok{, }\AttributeTok{min =} \SpecialCharTok{{-}}\DecValTok{1}\NormalTok{, }\AttributeTok{max =} \DecValTok{1}\NormalTok{)) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{inner =}\NormalTok{ x}\SpecialCharTok{\^{}}\DecValTok{2} \SpecialCharTok{+}\NormalTok{ y}\SpecialCharTok{\^{}}\DecValTok{2} \SpecialCharTok{\textless{}} \DecValTok{1}\NormalTok{)}

\DecValTok{4} \SpecialCharTok{*} \FunctionTok{mean}\NormalTok{(dat\_random}\SpecialCharTok{$}\NormalTok{inner)}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-168-2} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-169-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-181-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-184-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-185-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-185-2} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-186-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-186-2} \end{center}
...
\hypertarget{ett-stickprov-av-icke-normalfuxf6rdelad-data}{%
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-196-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-199-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-222-1} \end{center}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dat\_leaf }\SpecialCharTok{\%\textgreater{}\%} 
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-276-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-277-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-283-1} \end{center}
...
## $emmeans
##  group  emmean    SE df lower.CL upper.CL
##  a      0.3860 0.307 45   -0.231    1.003
##  b      0.0933 0.307 45   -0.524    0.711
##  c     -0.2616 0.307 45   -0.879    0.356
##  d     -0.1581 0.307 45   -0.776    0.459
##  e      0.0919 0.307 45   -0.526    0.709
## 
## Confidence level used: 0.95 
## 
## $contrasts
##  contrast estimate    SE df t.ratio p.value
##  a - b     0.29270 0.434 45   0.675  0.5031
##  a - c     0.64759 0.434 45   1.494  0.1422
##  a - d     0.54412 0.434 45   1.255  0.2160
##  a - e     0.29416 0.434 45   0.678  0.5009
##  b - c     0.35489 0.434 45   0.819  0.4174
##  b - d     0.25142 0.434 45   0.580  0.5649
##  b - e     0.00146 0.434 45   0.003  0.9973
##  c - d    -0.10347 0.434 45  -0.239  0.8125
##  c - e    -0.35342 0.434 45  -0.815  0.4193
##  d - e    -0.24996 0.434 45  -0.577  0.5671
\end{verbatim}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-297-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-308-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-315-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-316-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-324-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-326-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-329-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-332-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-334-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-334-2} \end{center}
