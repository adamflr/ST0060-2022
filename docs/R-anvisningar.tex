...
## # ... with 76,612 more rows, 14 more variables: loudness <dbl>, mode <dbl>,
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{unique}\NormalTok{(dat}\SpecialCharTok{$}\NormalTok{artist\_name)                }\CommentTok{\# Skriv ut unika värden i kolumnen artist\_name i dat}
\end{Highlighting}
\end{Shaded}
...
## # ... with 1,132 more rows, 14 more variables: loudness <dbl>, mode <dbl>,
## #   speechiness <dbl>, acousticness <dbl>, instrumentalness <dbl>,
## #   liveness <dbl>, valence <dbl>, tempo <dbl>, time_signature <dbl>,
## #   explicit <lgl>, type <chr>, key_name <chr>, mode_name <chr>,
## #   key_mode <chr>, and abbreviated variable names 1: artist_name,
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dat }\OtherTok{\textless{}{-}}\NormalTok{ dat }\SpecialCharTok{\%\textgreater{}\%}                                             \CommentTok{\# Ta datan, och sen}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{beats\_per\_second =}\NormalTok{ tempo }\SpecialCharTok{/} \DecValTok{60}\NormalTok{)                    }\CommentTok{\# Beräkna en ny kolumn som tempo delat på 60}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dat }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{select}\NormalTok{(tempo, beats\_per\_second)                    }\CommentTok{\# Ta datan och sen välj två kolumner}
\end{Highlighting}
\end{Shaded}
...
Följande stycke beräknar kvoten av kolumnerna valence och danceability i en ny kolumn \texttt{val\_to\_dan}.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dat }\SpecialCharTok{\%\textgreater{}\%}                                                    \CommentTok{\# Ta datan, och sen}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{val\_to\_dan =}\NormalTok{ valence }\SpecialCharTok{/}\NormalTok{ danceability) }\SpecialCharTok{\%\textgreater{}\%}          \CommentTok{\# beräkna valence delat på danceability, och sen}
  \FunctionTok{select}\NormalTok{(valence, danceability, val\_to\_dan)                }\CommentTok{\# välj relevanta kolumner.}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{dat }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{mutate}\NormalTok{(}\StringTok{\textasciigrave{}}\AttributeTok{Val to dan}\StringTok{\textasciigrave{}} \OtherTok{=}\NormalTok{ valence }\SpecialCharTok{/}\NormalTok{ danceability) }\SpecialCharTok{\%\textgreater{}\%}        \CommentTok{\# Namnet Val to dan skrivs inom backticks}
  \FunctionTok{select}\NormalTok{(artist\_name, }\StringTok{\textasciigrave{}}\AttributeTok{Val to dan}\StringTok{\textasciigrave{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
## # A tibble: 76,622 x 2
##    artist_name `Val to dan`
##    <chr>              <dbl>
##  1 100 gecs           1.81 
##  2 100 gecs           0.726
##  3 100 gecs           0.683
...
\FunctionTok{ggplot}\NormalTok{(dat\_mean\_over\_time, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ album\_release\_year, }\AttributeTok{y =}\NormalTok{ Mean\_danceability, }\AttributeTok{color =}\NormalTok{ explicit)) }\SpecialCharTok{+} 
                                                      \CommentTok{\# Koppla kolumner till egenskaper}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{mean}\NormalTok{(dat}\SpecialCharTok{$}\NormalTok{tempo, }\AttributeTok{na.rm =}\NormalTok{ T)                       }\CommentTok{\# Beräkna medelvärdet av kolumnen tempo i datan dat}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{gdpPercap }\OtherTok{\textless{}{-}}\NormalTok{ gapminder}\SpecialCharTok{$}\NormalTok{gdpPercap       }\CommentTok{\# Skapa en vektor gdpPercap genom att ta ut kolumnen från gapminder}
\FunctionTok{mean}\NormalTok{(gdpPercap)                        }\CommentTok{\# Beräkna medelvärdet av gdpPercap}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{var}\NormalTok{(gdpPercap)                                   }\CommentTok{\# Beräkna variansen av gdpPercap}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-287-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-288-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-294-1} \end{center}
...
## $emmeans
##  group  emmean    SE df lower.CL upper.CL
##  a      0.1606 0.344 45   -0.532    0.853
##  b     -0.2048 0.344 45   -0.897    0.487
##  c     -0.2800 0.344 45   -0.972    0.412
##  d     -0.0123 0.344 45   -0.704    0.680
##  e      0.2250 0.344 45   -0.467    0.917
## 
## Confidence level used: 0.95 
## 
## $contrasts
##  contrast estimate    SE df t.ratio p.value
##  a - b      0.3655 0.486 45   0.752  0.4560
##  a - c      0.4407 0.486 45   0.907  0.3694
##  a - d      0.1729 0.486 45   0.356  0.7237
##  a - e     -0.0644 0.486 45  -0.132  0.8952
##  b - c      0.0752 0.486 45   0.155  0.8778
##  b - d     -0.1926 0.486 45  -0.396  0.6938
##  b - e     -0.4299 0.486 45  -0.884  0.3812
##  c - d     -0.2678 0.486 45  -0.551  0.5844
##  c - e     -0.5050 0.486 45  -1.039  0.3043
##  d - e     -0.2373 0.486 45  -0.488  0.6278
\end{verbatim}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-319-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-327-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-336-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-336-2} \end{center}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dune\_data }\OtherTok{\textless{}{-}}\NormalTok{ dune }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{select}\NormalTok{(}\SpecialCharTok{{-}}\NormalTok{Site, }\SpecialCharTok{{-}}\NormalTok{Type)}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-338-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-339-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-340-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-343-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-345-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-347-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-350-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-353-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-355-1} \end{center}
...
\begin{center}\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-355-2} \end{center}
