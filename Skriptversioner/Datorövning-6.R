...
# Notera att ordningen på vektorerna påverkar konfidensintervall men inte p-värdet (i fallet med en
# tvåsidig mothypotes). Här är det naturligt att ta den andra mätningen först eftersom
# konfidensintervallet då blir ett intervall för medelvärdesökningen efter behandling. Ett p-värde på
