...
#
# Som exempel kan vi ett myntkast. Om man singlar ett balanserat mynt tio gånger kommer antalet
...
#
# Gör lämpliga ändringar i kodstycket ovan för att illustrera sannolikheten att få tre eller färre
...
#
# Ändra kodstycket från *exemplet* ovan för att illustrera sannolikheterna i uppgiften.
# :::
#
...
#
# 1. Ta tre punkter i planet så att de bildar en triangel.
# 2. Ta en startpunkt inom triangeln. Kalla den x0.
# 3. Välj slumpmässigt en av de tre ursprungliga punkterna och beräkna punkten mellan x0 och den
# valda punkten. Detta ger en ny punkt, x1.
# 4. Välj slumpmässigt en av de tre ursprungliga punkterna och beräkna punkten mellan x1 och den
# valda punkten. Detta ger en ny punkt, x2.
