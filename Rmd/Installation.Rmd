...
**2022-08-11.** RStudio har nyligen annonserat ett namnbyte till *Posit*. Om du läser det här bortom slutet av 2022 kommer det som sägs om RStudio alltså istället gälla Posit.
